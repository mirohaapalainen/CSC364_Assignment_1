...
def receive_packet(connection, max_buffer_size):
    ...
    # If the other side closes the connection cleanly recv should return b''
    ...
    write_to_file("./output/received_by_router_4.txt", ",".join(decoded_packet))
    ...
    while True:
        ...
        if send_port == "8005":
            ...
            try:
                ...
                client.sendall(new_packet.encode())
                client.close()
